...
public class NewGameGUI extends JPanel {
	 ...
	 */
	public NewGameGUI(Bejeweled bj, MenuGUI menu) {
		this.game = bj;
		...
		//TITULO
		label = new JLabel("");
		label.setIcon(new ImageIcon("Resources/Icons/TxtNovoJogo.png"));
		label.setHorizontalAlignment(SwingConstants.CENTER);
		label.setBounds(350, 79, 102, 60);
		this.add(label);
	...
	private void JogoClassicoActionPerformed(ActionEvent evt) {
		this.getGame().startGame(false, false);
	}
	...
	private void JogoVelocidadeActionPerformed(ActionEvent evt) {
		this.getGame().startGame(true, false);
	}
